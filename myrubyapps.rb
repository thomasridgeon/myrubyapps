    ...
    html do
      ...
      body(class: 'bg-white text-black') do
        ...
        div(class: 'max-w-2xl p-6 flex flex-col items-start ml-20') do
          ...
          h2(class: 'text-xl font-bold my-8') do
          ...
          h3(class: 'text-lg font-bold my-4') do
          ...
          h4(class: 'text-lg font-bold my-4') do
          ...
          h5(class: 'text-lg font-bold my-4') do
          ...
          h6(class: 'text-lg font-bold my-4') do
            text 'Conclusion'
          end
          p(class: 'text-base mb-4') do
          ...
          # References
          div(class: 'text-lg') do
            h1(class: 'my-6 font-bold underline') do
              text 'References'
            end
            p(class: 'text-sm mt-4') do
              text 'Holick, M. F., et al. (2011). Vitamin D: A D-Lightful health perspective. Journal of Clinical Endocrinology & Metabolism.'
            end
            a(href: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC3738435/', class: 'text-sm mb-4 underline') do
            ...
            a(href: 'https://www.tandfonline.com/doi/full/10.4161/derm.24494', class: 'text-sm mb-4 underline') do
            ...
            a(href: 'https://ec.europa.eu/health/scientific_committees/scheer/docs/sunbeds_co240m_en.pdf',
              class: 'text-sm mb-4 underline') do
            ...
            a(href: 'https://pubmed.ncbi.nlm.nih.gov/9916136/', class: 'text-sm mb-4 underline') do
            ...
            a(href: 'https://pubmed.ncbi.nlm.nih.gov/19302999/', class: 'text-sm mb-4 underline') do
            ...
            a(href: 'https://academic.oup.com/jcem/article/99/10/E2133/2836264', class: 'text-sm mb-4 underline') do
            ...
            a(href: 'https://pubmed.ncbi.nlm.nih.gov/26766556/', class: 'text-sm mb-4 underline') do
            ...
            a(href: 'https://www.mdpi.com/1660-4601/17/14/5014', class: 'text-sm mb-4 underline') do
            ...
            a(
              href: 'https://aspe.hhs.gov/sites/default/files/private/pdf/264486/74-Sunshine-Health-Foundation-IQ-Appeal-Hoel-etal-2016.pdf', class: 'text-sm mb-4 underline'
            ) do
            ...
            a(href: 'https://pubmed.ncbi.nlm.nih.gov/26098394/', class: 'text-sm mb-4 underline') do
